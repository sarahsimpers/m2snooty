...
python3 ~/$projects/m2r/m2r.py ~/$projects/cloud-docs/source/includes/sdk/go/markdown/concepts.txt
mv ~/$projects/cloud-docs/source/includes/sdk/go/markdown/concepts.rst ~/$projects/cloud-docs/source/sdk/go/concepts.txt
python3 ~/$projects/m2r/m2r.py ~/$projects/cloud-docs/source/includes/sdk/go/markdown/authentication.txt
...
python3 ~/$projects/m2r/m2r.py ~/$projects/cloud-docs/source/includes/sdk/go/markdown/error_handling.txt
...
python3 ~/$projects/m2r/m2r.py ~/$projects/cloud-docs/source/includes/sdk/go/markdown/migration.txt
mv ~/$projects/cloud-docs/source/includes/sdk/go/markdown/migration.rst ~/$projects/cloud-docs/source/sdk/go/migration.txt
python3 ~/$projects/m2r/m2r.py ~/$projects/cloud-docs/source/includes/sdk/go/markdown/reference.txt
